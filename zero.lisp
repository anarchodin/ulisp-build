...
(defparameter *compile-options-zero* #"
// Compile options
...
(defparameter *global-variables-zero* #"
// Global variables
...
(defparameter *make-objects-zero* #"
...
(defparameter *garbage-collection-zero* #"
// Garbage collection
...
(defparameter *compactimage-zero* "")

(defparameter *make-filename-zero* "")

(defparameter *error-handling-zero* #"
// Error handling
...
(defparameter *tracing-zero* "")


(defparameter *helper-functions-zero* #"
// Helper functions
...
(defparameter *association-lists-zero* "")


(defparameter *string-utilities-zero* "")


(defparameter *closures-zero* #"
...
(defparameter *i2c-interface-zero* "")


(defparameter *definitions-zero*
...
(defparameter *print-functions-zero* #"
// Print functions
...
(defparameter *read-functions-zero* #"
int gchar () {
  if (LastChar) { 
    char temp = LastChar;
    LastChar = 0;
